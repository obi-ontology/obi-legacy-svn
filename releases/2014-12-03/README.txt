= Ontology for Biomedical Investigations Release 2014-12-03 =

Date of Release: 2014-12-03

Subversion Revision: 3955

== Access ==

* This version in OWL format: http://purl.obolibrary.org/obo/obi/2014-12-03/obi.owl
* This release directory in Subversion: https://sourceforge.net/p/obi/code/HEAD/tree/releases/2014-12-03/
...
This release candidate was built using revision 3955 of the new OBI build tools:

http://sourceforge.net/p/obi/code/HEAD/tree/trunk/src/tools/build/

== New in this Release ==

We have added 19 new terms, see docs/newIDs.tab for details:

* OBI_0001957 hardware testing design
* OBI_0001958 systematic review study design
* OBI_0001959 sequencing library multiplexing
* OBI_0001960 taxonomic diversity assessment by targeted gene survey
* OBI_0001961 PCR program
* OBI_0001962 target gene specification
* OBI_0001963 target subfragment specification
* OBI_0001964 decision-theoretic analysis objective
* OBI_0001965 decision analysis study design
* OBI_0001966 sequence library deconvolution
* OBI_0001967 multiplexing sequence identifier
* OBI_0001968 operational taxonomic unit matrix
* OBI_0001969 biodiversity assessment objective
* OBI_0001970 multiplexed sequencing library
