= Ontology for Biomedical Investigations Release 2015-12-07 =

Date of Release: 2015-12-07

Subversion Revision: 4022

== Access ==

* This version in OWL format: http://purl.obolibrary.org/obo/obi/2015-12-07/obi.owl
* This release directory in Subversion: https://sourceforge.net/p/obi/code/HEAD/tree/releases/2015-12-07/
...
This release candidate was built using revision 4022 of the new OBI build tools:

http://sourceforge.net/p/obi/code/HEAD/tree/trunk/src/tools/build/

== New in this Release ==

There are 10 new classes since the 2015-10-20 release:

* OBI:0002076 collection of specimens
* OBI:0002077 specimens derived from shared ancestor
* OBI:0002078 specimen set collection process
* OBI:0002079 specimens collected in one encounter
* OBI:0002080 human specimen set
* OBI:0002081 specimens collected longitudinally
