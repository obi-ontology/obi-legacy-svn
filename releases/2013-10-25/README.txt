...
In October we switched to a new import system using OntoFox. See the branches/OntoFox_inputs and branches/OntoFox_outputs directories for details. The most significant difference is a large reduction in the number of terms that we import from NCBI Taxonomy.
