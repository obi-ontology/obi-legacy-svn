...
public class OBIReleaseClient {
    public static void main(String [] args)
    {
    	...
    	OBIClassifier classifier = new OBIClassifier();
    	...
    	if (args.length != 3){
    		System.out.println ("You need to pass the correct arguments, first the path of the file that will be created,i.e. the merged file, second the path of the protege friendly file and third the physical URI of the files.");
		...
		//check consistency => now done via OWLAPI and Pellet, I need it for equivalent classes check
		/*boolean valid = classifier.checkConsistency(newFilePath);
		...
		classifier.checkConsistency(newFilePath); 
		*/
