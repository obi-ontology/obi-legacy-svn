= Ontology for Biomedical Investigations Release 2014-03-29 =

Date of Release: 2014-03-29

Subversion Revision: 3931

== Access ==

* This version in OWL format: http://purl.obolibrary.org/obo/obi/2014-03-29/obi.owl
* This release directory in Subversion: https://sourceforge.net/p/obi/code/HEAD/tree/releases/2014-03-29/
...
This release candidate was built using revision 3931 of the new OBI build tools:

http://sourceforge.net/p/obi/code/HEAD/tree/trunk/src/tools/build/

== New in this Release ==

This is the first release using the new release process:

http://obi-ontology.org/page/OBI_Release_Policy

We have made it explicit that OBI is released under a Creative Commons CC-by 3.0 license, in accordance with OBO Foundry principle 1:

http://www.obofoundry.org/wiki/index.php/FP_001_open

We have added 41 new terms, see docs/newIDs.tab for a list.
