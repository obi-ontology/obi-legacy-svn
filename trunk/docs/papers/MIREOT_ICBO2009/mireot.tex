...
\begin{description}
 ...
 \item[target parent URI] The logical URI for the class in the target ontology that the external class should be imported under. %DS: maby make it independent from OBI: own ontologies superclass
 \end{description} 
...
%FG the word axiomatisation does not exist
...
\acro{MIREOT}{Minimum Information to Represent an External Ontology Term}
