...
Second, the other ontologies used may be under active development and not aligned with the chosen development approach. Importing -policy wise- heterogenous ontologies as a whole could lead to inconsistencies or unintended inferences.
In this paper we propose a new minimum information standard for importing required terms from an external artefact into an own ontology. 
...
Second, external ontologies may be under active development and not aligned with the design of the resource that needs to reference their terms. 
