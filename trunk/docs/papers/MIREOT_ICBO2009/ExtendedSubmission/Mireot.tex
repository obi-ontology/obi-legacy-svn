...
Gene Ontology Consortium. The gene ontology (go) database and informatics resource, \textit{Nucleic acids research} \textbf{32(90001)}, D258-D261.

\bibitem[\protect\citeauthoryear{Sirin, E. et al.}{2007}]{Sirin}
 Sirin, E., Parsia, B., Grau, B. C., Kalyanpur, A., and Katz, Y. (2007). Pellet: A practical OWL-DL reasoner. \textit{Web Semant.} \textbf{5}, 51-53. 
...
research, } \textbf{33(Database issue)}, D39-45.
