...
\ac{MIREOT} provides a mechanism by which external ontology terms can be selectively imported, even if they do not use a particular upper ontology or OWL DL~\citep{OWLGuide}, and hence contribute to the realization of OBO Foundry principles.
