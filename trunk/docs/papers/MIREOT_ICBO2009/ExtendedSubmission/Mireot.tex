...
A webservice, OntoFox\cite{OntoFox}, has been developed by the He group at the UNiversity of Michigan to facilitate the process: users can use web forms to input their requirements, or submit specifically formatted files.
