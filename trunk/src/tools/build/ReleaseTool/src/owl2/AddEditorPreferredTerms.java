...
public class AddEditorPreferredTerms {
	...
	public static void main(String[] args) {
		// values should get from arguments
		String filename = "C:/Documents and Settings/Jie/My Documents/Ontology/obi/trunk/src/ontology/branches/obi.owl";
		String saveFilename = "C:/Documents and Settings/Jie/My Documents/Ontology/obi/trunk/src/ontology/branches/obi-new.owl";
    	...
    	// load ontology
    	OWLOntology ont = OntologyManipulator.loadFromFile(filename, manager);
